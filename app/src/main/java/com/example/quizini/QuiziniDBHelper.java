...
import com.example.quizini.QuiziniContract.*;

import java.util.ArrayList;
import java.util.List;

public class QuiziniDBHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "QuiziniQuizLearning";
    ...
    public QuiziniDBHelper(Context context) {
